...
import useUpdaterCampaign from "../../../hooks/influencer/useCustomUpdateCampaign";
...
const Draws = () => {
  const { id } = useParams();
  const updateCampaign = useUpdaterCampaign(Number(id));
  useErrorHandler(updateCampaign, "Updated Campaign Successful", " Error");
  const { isLoading, isError, data, error } = useQuery(
    ...
    const formSchema = z.object({
      ...
      ticket_sale_cap: z
        ...
        .refine(
          (value) => Number(value) <= 1000000,
          "number of tickets must be a number"
        ),
      brand_colors: z
        .array(z.string())
        .refine(
  ...
  const onSubmit: SubmitHandler<FormSchmaType> = async (data) => {
    ...
    console.log(req);
    await updateCampaign.mutateAsync(req);
  };
          ...
          <BackgroundDrop>
              ...
              <div className="w-full lg:w-[70%] ">
                <div className="flex  justify-between flex-wrap">
                  <input
                    ...
                    defaultValue={
                      new Date(
                        countDown(data?.data?.start_date).year,
                        countDown(data?.data?.start_date).month,
                        countDown(data?.data?.start_date).day
                      )
                        .toISOString()
                        .split("T")[0]
                    }
            ...
            <div className="flex flex-col lg:flex-row justify-between mt-[1rem] lg:mt-[2rem]">
              ...
              <div className="w-full lg:w-[70%] ">
                <select
                  ...
                  className={`w-full border text-sm bg-bg lg:text-base text-forms border-formborder p-3 rounded-[10px] outline-none placeholder:text-forms placeholder:text-sm placeholder:opacity-[.6]`}
                  {...register("recurring")}
                  defaultValue={data?.data?.recurent}
                >
            ...
            <div className="flex flex-col lg:flex-row justify-between mt-[1rem] lg:mt-[2rem]">
              ...
              <input
                ...
                disabled={isSubmitting}
                defaultValue={data?.data?.number_of_winners}
              />
            </div>
            ...
            <div className="flex flex-wrap justify-between mt-[1rem] lg:mt-[2rem]">
              ...
              <div className="w-full lg:w-[70%] ">
                <select
                  ...
                  {...register("draw_type", { required: "This is required." })}
                  defaultValue={data?.data?.draw_type}
                >
                  <option className="text-sm opacity-[.6]" value="">
                    Select an option
                  </option>
            ...
            <div className="flex flex-col lg:flex-row flex-Wrap justify-between mt-[1rem] lg:mt-[2rem]">
              ...
              <div className="flex items-center w-full lg:w-[70%]">
                ...
                <input
                  ...
                  disabled={isSubmitting}
                  defaultValue={data?.data?.ticket?.ticket_prize}
                />
              </div>
            </div>
            <ErrorMessage
            ...
            <div className="flex flex-col lg:flex-row justify-between mt-[1rem] lg:mt-[2rem]">
              ...
              <div className="w-full lg:w-[70%] ">
                <input
                  ...
                  disabled={isSubmitting}
                  defaultValue={data?.data?.ticket?.ticket_sale_cap}
                />
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between mt-[1rem] lg:mt-[2rem]">
              ...
              >
                <input
                  ...
                  defaultValue={JSON.parse(data?.data?.brand_colors)[0]}
                />
                <input
                  type="color"
                  ...
                  defaultValue={JSON.parse(data?.data?.brand_colors)[1]}
                  className="block hover:opacity-80 cursor-pointer rounded-full w-[30px] h-[30px]  mr-2 border-0 bg-white"
                />
                <input
                  type="color"
                  ...
                  defaultValue={JSON.parse(data?.data?.brand_colors)[2]}
