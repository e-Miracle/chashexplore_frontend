...
const ReviewCard: React.FC<Props> = (props) => {
  return (
    <div className="font-ubuntu bg-white rounded-[10px] p-[1rem]">
      <h3 className="text-base lg:text-[1.25rem] text-labels leading-[2]">{props.text}</h3>
      ...
      <div className="flex items-center mt-5">
        ...
        <div className="ml-2 ">
          ...
          <p className="text-primary text-sm lg:text-base font-semibold">Winner, N{props.amount}</p>
        </div>
      </div>
    </div>
  );
