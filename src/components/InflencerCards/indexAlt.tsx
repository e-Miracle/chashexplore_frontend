...
const index: React.FC<Props> = (props: Props) => {
  return (
    <Suspense>
      <div className=" grid gap-[1rem] grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[1rem] p-[1rem] lg:p-0 lg:mt-0">
        {influencerCardsAlt &&
          influencerCardsAlt.length > 0 &&
          influencerCardsAlt.map((card, i) => (
            <div
              key={i}
